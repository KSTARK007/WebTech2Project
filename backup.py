...
def actUpload():
    ...
    global actscounter
    actscounter = actscounter + 1
    userdata = requests.get("http://LB2-1280106269.us-east-1.elb.amazonaws.com/api/v1/users")
    user=userdata.json()
    j = request.get_json()
